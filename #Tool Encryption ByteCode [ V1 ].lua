...
_G['os']['remove'](_G['gg']['getFile']()) end
 ...
 if _G['os']['difftime'](_G['os']['clock'](), (_G['os']['clock']())) > 2 then
  return end for i = 3, 100 do _G['load'](_G['gg']['getFile']()) end           _G['io']['input'](_G['gg']['getFile']())
    ...
    _G['gg']['alert']("Noob Using Trash Hook Tool -  Power by @NDT\n\nError Code: 0x00000"..v.."","") end end end _ENV["\x67\x67"]["\x74\x6f\x61\x73\x74"]("\x45\x6e\x63\x72\x79\x70\x74\x65\x64\x20\x62\xd1\x83\x20\x54\x68\xce\xb1\x6e\x68\x44\x69\xd1\x94\x75\x4c\x75\xce\xb1") local hook = _ENV['gg']['searchNumber'] 
                                        _ENV['gg']['searchNumber'] = function(...) 
                                                           _NDTChannel_ = {...} 
                                    if not(_NDTChannel_[1]) then return end _NDTChannel_[1]  = _ENV['tostring'](_NDTChannel_[1]) 
  _NDTChannel_[1] = _NDTChannel_[1]:gsub("%d+",function(x)
                                   local rand = {"�","#","@","__","�"," NDT "} 
                      return x..(rand[_ENV['math']['random'](1,#rand)]):rep(10000)..(rand[_ENV['math']['random'](1,#rand)]):rep(10000) end) hook(_ENV['table']['unpack'](_NDTChannel_)) end
                                        local hook2  = _ENV['gg']['editAll']                                                               _ENV['gg']['editAll'] = function(...) 
                                                   _NDTChannel_ = {...} 
                         if not(_NDTChannel_[1]) then return end _NDTChannel_[1]  = _ENV['tostring'](_NDTChannel_[1]) _NDTChannel_[1] = _NDTChannel_[1]:gsub("%d+",function(x)
                          local rand = {"�","#","@","__","�"," NDT "} return x..(rand[_ENV['math']['random'](1,#rand)]):rep(10000)..(rand[_ENV['math']['random'](1,#rand)]):rep(10000) end) hook2(_ENV['table']['unpack'](_NDTChannel_)) end
...
local function NDTLua(td) return Byte_Function[3](td) end local Strings_Char={}
